...
class ImageDatasetJson(Dataset):
    ...
    """
    def __init__(self, cfg: DatasetConfig, extension: str = '.jpg',
        ...
        self.img_ids = [Path(file).stem for file in os.listdir(self.img_dir) if Path(file).suffix == self.extension]
